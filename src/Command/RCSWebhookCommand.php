...
class RCSWebhookCommand extends Command
{
    use TelegramTrait;
    ...
    public function __construct(RCSClient $rcsClient, RouterInterface $router)
    {
        parent::__construct();

        $this->rcsClient = $rcsClient;
        $this->router = $router;
    }
